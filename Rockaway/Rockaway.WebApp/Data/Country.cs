...
{
    private static readonly Dictionary<string, string> iso3166;

    static Country()
    {
        iso3166 = new(StringComparer.InvariantCultureIgnoreCase)
        {
            { "AF", "Afghanistan" },
            { "AX", "Åland Islands" },
            { "AL", "Albania" },
        ...
        AllCountries = iso3166.Select(entry => new Country(entry.Key, entry.Value));
    }
