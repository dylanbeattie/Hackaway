...
namespace Rockaway.WebApp.Migrations
{
    ...
    [Migration("20231009153936_TicketsAndShows")]
    partial class TicketsAndShows
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9d3dd3df-097b-40ad-bdb5-bd37a36559d8",
                            Email = "admin@rockaway.dev",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@ROCKAWAY.DEV",
                            NormalizedUserName = "ADMIN@ROCKAWAY.DEV",
                            PasswordHash = "AQAAAAIAAYagAAAAECYZtAjsVEMyr9a5Jax3nh3MkZZOqPM5G8L1f6ZHZeeanL86NYiEN7hpjRNgLSisfA==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "9230f736-519d-4f48-a981-316016a53606",
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.Show", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            VenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb6"),
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.SupportSlot", b =>
                {
                    ...
                    b.HasKey("Position", "ShowDate", "ShowVenueId");
                    ...
                    b.HasData(
                        ...
                        {
                            Position = 0,
                            ShowDate = new DateTime(2023, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1"),
                        ...
                        {
                            Position = 0,
                            ShowDate = new DateTime(2023, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Position = 0,
                            ShowDate = new DateTime(2023, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb6"),
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa9")
                        },
                        new
                        {
                        ...
                        {
                            Position = 0,
                            ShowDate = new DateTime(2023, 12, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Position = 0,
                            ShowDate = new DateTime(2023, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.Ticket", b =>
                {
                    b.HasOne("Rockaway.WebApp.Data.Entities.TicketOrder", "Order")
                        .WithMany("Tickets")
